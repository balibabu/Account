...
// import BalancedFinancialGraph from '../../components/BalancedFinancialGraph';
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.balanceText}>Rs {dashboardData.balance}</Text>
                </View>
                ...
                <View style={styles.row}>
                    <View style={[styles.card, styles.halfCard]}>
                        ...
                        <Text style={[styles.statAmount, { color: '#2E7D32' }]}>Rs {dashboardData.income}</Text>
                    </View>
                    ...
                    <View style={[styles.card, styles.halfCard]}>
                        ...
                        <Text style={[styles.statAmount, { color: '#C62828' }]}>Rs {dashboardData.expense}</Text>
                    </View>
                </View>
                    ...
                    {dashboardData.recent.length === 0 ? (
                        ...
                        dashboardData.recent.map((item) => (
                            <View key={item.id} style={styles.transactionItem}>
                                ...
                                <View style={[
                                    styles.transIcon,
                                    item.category === 0 ? styles.bgGreen : styles.bgRed
                                ]}>
                                ...
                                <Text style={[
                                    styles.transAmount,
                                    item.category === 0 ? { color: '#2E7D32' } : { color: '#C62828' }
                                ]}>
                                    {item.category === 0 ? '+' : '-'}{formatMoney(item.amount)}
                                </Text>
                            </View>
                        ))
                    )}
